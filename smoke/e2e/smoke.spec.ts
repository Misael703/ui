...
const ROUTES = ['/', '/client', '/gallery', '/scenarios', '/scenarios/modal', '/scenarios/brand', '/scenarios/table', '/scenarios/badges', '/scenarios/timeline-milestone', '/scenarios/timeline-milestone-compact'];
