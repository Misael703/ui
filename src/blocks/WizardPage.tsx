'use client';
/**
 * Block: multi-step form (a "wizard"). Stepper on the left, form area on
 * the right, Back/Next/Finish buttons in a sticky footer. Example shown:
 * creating a new shipping order in 4 steps.
 *
...
const STEPS = [
  { label: 'Cliente',     description: 'Selecciona el destinatario' },
...
export function WizardPage(): React.ReactElement {
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', padding: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', gap: 32, alignItems: 'start', marginTop: 24 }}>
